...
data = {'path': '/ifs/data', 'type': 'directory'}
response = session.delete(
    papi + endpoint, data=json.dumps(data), headers=headers, verify=False)

if 200 <= response.status_code < 299:
    print("Quota Delete Successful")
else:
    print("Quota Delete Failed")
    print(response.content)
